...
基于Qwen2.5-0.5B-Instruct的LCQMC文本匹配模型，具有以下特性：
...
LCQMC（Large-scale Chinese Question Matching Corpus）是一个大规模中文问句匹配数据集：
- 训练集：238,766条
- 验证集：8,802条
- 测试集：12,500条
...
加载数据集...
随机采样数据集 (采样比例: 0.1)...
采样后训练集: 23,877条 (原始: 238,766条)
采样后验证集: 881条 (原始: 8,802条)
采样后测试集: 1,250条 (原始: 12,500条)
