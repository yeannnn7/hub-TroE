...
class BiEncoder(nn.Module):
    ...
    def __init__(self, model_name='bert-base-chinese', hidden_size=None, num_hidden_layers=3, config_name=None):
        super().__init__()
        ...
        self.hidden_size = self.bert.config.hidden_size if hidden_size is None else hidden_size
...
class BiEncoderForClassification(nn.Module):
    ...
    def __init__(self, model_name='bert-base-chinese', hidden_size=None, num_hidden_layers=3, config_name=None):
        ...
        encoder_hidden_size = self.encoder.hidden_size if hidden_size is None else hidden_size
