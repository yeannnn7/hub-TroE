...
class QueryRequest(BaseModel):
    question:   str           = Field(...,  example="铁路旅客免费携带行李的重量限制是多少？")
    category:   Optional[str] = Field(None, example="铁路")
    year:       Optional[str] = Field(None, example="2024")
